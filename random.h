`
// This is taken from learncpp.com, I could have made this myslef but I wanted to use something 
// from the first coding learning source that I ever used to be in my first project.
